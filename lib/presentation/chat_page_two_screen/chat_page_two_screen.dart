...
import 'package:ehem_foundation_project/presentation/options_three_bottomsheet/options_three_bottomsheet.dart';

// ignore_for_file: must_be_immutable
class ChatPageTwoScreen extends StatelessWidget {
  ChatPageTwoScreen({Key? key}) : super(key: key);
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                          padding: EdgeInsets.only(left: 100.h),
                          child: _buildPersonalChatBubble(context,
                              messageText: "Thank you so much for your help",
                              readText: "17:03 · Read")),
                      SizedBox(height: 16.v),
                      Container(
  ...
  /// Shows a modal bottom sheet with [OptionsThreeBottomsheet]
  /// widget content.
  /// The sheet is displayed on top of the current view with scrolling enabled if
  /// content exceeds viewport height.
  onTapTablerDots(BuildContext context) {
    showModalBottomSheet(
        context: context,
        builder: (_) => OptionsThreeBottomsheet(),
