...
import 'package:ehem_foundation_project/presentation/options_two_bottomsheet/options_two_bottomsheet.dart';

// ignore_for_file: must_be_immutable
class ChatPageThreeScreen extends StatelessWidget {
  ChatPageThreeScreen({Key? key}) : super(key: key);
  ...
  /// Shows a modal bottom sheet with [OptionsTwoBottomsheet]
  /// widget content.
  ...
  onTapTablerDots(BuildContext context) {
    showModalBottomSheet(
        context: context,
        builder: (_) => OptionsTwoBottomsheet(),
