...
class ChatPageOneScreen extends StatelessWidget {
  ChatPageOneScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the sendingAMessageScreen when the action is triggered.
  onTapFrame(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.sendingAMessageScreen);
  }
}
