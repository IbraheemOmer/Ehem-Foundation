...
class ServicesAcceptedFinancailAidOneScreen extends StatelessWidget {
  ServicesAcceptedFinancailAidOneScreen({Key? key})
      : super(
          key: key,
        );
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Text(
                  "We are really sorry to inform you that your finical aid \nwith the email ( Example@gmail.com )\n\n has been refused  ",
                  maxLines: 5,
