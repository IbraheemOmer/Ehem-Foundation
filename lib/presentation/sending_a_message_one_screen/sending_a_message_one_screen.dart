...
class SendingAMessageOneScreen extends StatelessWidget {
  SendingAMessageOneScreen({Key? key}) : super(key: key);
  ...
  /// Navigates to the sendingAttachmentsScreen when the action is triggered.
  onTapImgImage(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.sendingAttachmentsScreen);
  }
}
